  ...
  return (
    <div className={classes.curItem}>
      ...
      <div className={classes.itemInfo}>
        <div className={classes.itemName}>choose your Toppings</div>
        <div className={`${classes.itemDescription} ${classes.half}`}>
          <p style={{ fontSize: "21px", fontStyle: "italic" }}>
            "Crafted with the finest ingredients, our pizza toppings provide the
...
export default ToppingsSpecialCurItem;
